    ...
    Private Sub btnSave_Click(sender As System.Object, e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            If txtActivationID.Text = TextBox1.Text Then
                ...
                Me.Hide()
            Else
                MessageBox.Show("Invalid activation id...Please contact software provider for buying full licence" & vbCrLf & "Contact me at :" & vbCrLf & "Raj Sharma" & vbCrLf & "Email-Sharma.raj@outlook.com" & vbCrLf & "Mobile No. +919827858191", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End If
        Catch ex As Exception
