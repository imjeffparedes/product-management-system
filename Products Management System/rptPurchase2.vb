...
Public Class rptPurchase2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Products_Management_System.rptPurchase2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchase2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchase2 = New rptPurchase2()
        rpt.Site = Me.Site
        Return rpt
    End Function
