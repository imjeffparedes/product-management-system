    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        ...
        Try
            ...
            If rdr.Read() Then
                ...
                If UserType.Text = "Operator" Then
                    frmMainMenu.RegistrationToolStripMenuItem.Enabled = False
                    frmMainMenu.LogsToolStripMenuItem.Enabled = False
                    frmMainMenu.DatabaseToolStripMenuItem.Enabled = False
                    frmMainMenu.DepartmentToolStripMenuItem.Enabled = False
                    frmMainMenu.CategoryToolStripMenuItem.Enabled = False
                    frmMainMenu.SubCategoryToolStripMenuItem.Enabled = False
                    frmMainMenu.ProductToolStripMenuItem.Enabled = True
                    frmMainMenu.CompanyToolStripMenuItem.Enabled = False
                ...
                If (UserType.Text = "Admin") Then
                    frmMainMenu.RegistrationToolStripMenuItem.Enabled = True
                    frmMainMenu.LogsToolStripMenuItem.Enabled = True
                    frmMainMenu.DatabaseToolStripMenuItem.Enabled = True
                    frmMainMenu.DepartmentToolStripMenuItem.Enabled = True
                    frmMainMenu.CategoryToolStripMenuItem.Enabled = True
                    frmMainMenu.SubCategoryToolStripMenuItem.Enabled = True
                    frmMainMenu.ProductToolStripMenuItem.Enabled = True
                    frmMainMenu.ReportToolStripMenuItem.Enabled = True
                    frmMainMenu.CompanyToolStripMenuItem.Enabled = True
                    frmMainMenu.lblUser.Text = UserID.Text
                    frmMainMenu.lblUserType.Text = UserType.Text
                    Dim st As String = "Successfully logged in"
                    LogFunc(UserID.Text, st)
