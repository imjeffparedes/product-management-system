...
Public Class rptPurchase1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Products_Management_System.rptPurchase1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchase1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchase1 = New rptPurchase1()
        rpt.Site = Me.Site
        Return rpt
    End Function
